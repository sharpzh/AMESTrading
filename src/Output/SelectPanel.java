...
public class SelectPanel extends javax.swing.JPanel {
    ...
    public SelectPanel(AMESFrame frame,boolean ifTableView, TableView view, SplitChart pFrame) {
        ...
        if(ifDisplayTable){
            ...
            outputDataTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "GenCo Commitments (Benchmark)", "GenCo Profits (Benchmark)","GenCo Net Earnings (Benchmark)", "LSE Price-Sensitive Demand (Benchmark)", "LSE Price-Sens. Net Earnings (Benchmark)", "LMPs (Benchmark)", "Total Supply&Demand (Benchmark)", "GenCo Reported Supply Offers", "GenCo Commitments", "GenCo Profits", "GenCo Net Earnings", "LSE Price-Sensitive Net Earnings", "Total Reported Supply & Demand", "LSE Price-Sensitive Demand", "Branch Power Flows", "LMPs","GenCo Emissions","GenCo Emission Trades","Emission Trades Costs" }));
    ...
    private void outputDisplayButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_outputDisplayButtonActionPerformed
        ...
        if(ifDisplayTable) {
            ...
            else  if(outputDataTypeSelect.equalsIgnoreCase("GenCo Emissions")) {
                tableView.displayGeneratorEmissionData(outputTimeTypeSelect, iStartTime, iEndTime, iDayHour, selectIndex);
            }
            else  if(outputDataTypeSelect.equalsIgnoreCase("GenCo Emission Trades")) {
                tableView.displayGeneratorEmTradeData(outputTimeTypeSelect, iStartTime, iEndTime, iDayHour, selectIndex);
            }
            else  if(outputDataTypeSelect.equalsIgnoreCase("Emission Trades Costs")) {
                tableView.displayGeneratorEmTradePriceData(outputTimeTypeSelect, iStartTime, iEndTime, iDayHour, selectIndex);
            }
            ...
            if(outputDataTypeSelect.equalsIgnoreCase("GenCo Commitments (Benchmark)")) {
                ...
                parentFrame.drawGeneratorEmissionData(outputTimeTypeSelect, iStartTime, iEndTime, iDayHour, selectIndex);
            }
            else  if(outputDataTypeSelect.equalsIgnoreCase("GenCo Emission Trades")) {
                parentFrame.drawGeneratorEmTradeData(outputTimeTypeSelect, iStartTime, iEndTime, iDayHour, selectIndex);
            }
            else  if(outputDataTypeSelect.equalsIgnoreCase("Emission Trades Costs")) {
                parentFrame.drawGeneratorEmTradePriceData(outputTimeTypeSelect, iStartTime, iEndTime, iDayHour, selectIndex);
            }
     }
